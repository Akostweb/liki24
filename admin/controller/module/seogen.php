...
class ControllerModuleSeogen extends Controller {
	...
	public function eventGenProduct_23($route, $arr) {
        $this->eventGenProduct($arr[0]);
    }
    public function eventGenCategory_23($route, $arr) {
        $this->eventGenCategory($arr[0]);
    }
    public function eventGenManufacturer_23($route, $arr) {
        $this->eventGenManufacturer($arr[0]);
    }
    public function eventGenInformation_23($route, $arr) {
