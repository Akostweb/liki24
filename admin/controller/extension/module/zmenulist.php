...
class ControllerExtensionModuleZmenuList extends Controller {
    ...
    public function index() {
        ...
        foreach ($this->lists as $sett) {
            $data['items'][] = array(
                'id' => $sett['id'],
                'name' => $sett['name'],
                'copy_href' => $this->url->link('extension/module/zmenulist/copy', 'id=' . $sett['id'] . '&token=' . $this->session->data['token'], true),
                'edit_href' => $this->url->link('extension/module/zmenulist/edit', 'id=' . $sett['id'] . '&token=' . $this->session->data['token'], true),
                'remove_href' => $this->url->link('extension/module/zmenulist/remove', 'id=' . $sett['id'] . '&token=' . $this->session->data['token'], true)
            );
        }


        $data['action'] = $this->url->link('extension/module/zmenu', 'token=' . $this->session->data['token'], true);
        $data['cancel'] = $this->getModulesLink();
        $data['add_href'] = $this->url->link('extension/module/zmenulist/edit', 'token=' . $this->session->data['token'], true);
        $data['clear_cache_href'] = $this->url->link('extension/module/zmenulist/clearcache', 'token=' . $this->session->data['token'], true);
        $data['zmenu_href'] = $this->url->link('extension/module/zmenu', 'token=' . $this->session->data['token'], true);
    ...
    private function getZmenuLink($list_id = 0) {
        return $this->url->link('extension/module/zmenulist', 'token=' . $this->session->data['token'] . ($list_id ? '&list_id=' . $list_id : ''), true);
    }
...
//            $this->_redirect($this->getZmenuLink());
    ...
    public function showListForm() {
        ...
        $data['action'] = $this->url->link('extension/module/zmenulist/edit', 'token=' . $this->session->data['token'], true);
        $data['cancel'] = $this->url->link('extension/module/zmenulist', 'token=' . $this->session->data['token'], true);
        $module_info = null;
        if (isset($this->request->get['id']) && isset($this->lists[$this->request->get['id']])) {
            $module_info = $this->lists[$this->request->get['id']];
            $data['action'] = $this->url->link('extension/module/zmenulist/edit', 'token=' . $this->session->data['token'] . '&id='.$this->request->get['id'], true);
        }
