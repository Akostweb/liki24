...
class ControllerExtensionModuleZmenu extends Controller {
    ...
    public function index() {
        ...
        $data['entry_list'] = sprintf($this->language->get('entry_list'), $this->url->link('extension/module/zmenulist', 'token=' . $this->session->data['token'], true));
        ...
        if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            ...
            $data['action'] = $this->url->link('extension/module/zmenu', 'token=' . $this->session->data['token'] . '&module_id='.$this->request->get['module_id'], true);
        }
    ...
    private function getZmenuLink($module_id = 0) {
        return $this->url->link('extension/module/zmenu', 'token=' . $this->session->data['token'] . ($module_id ? '&module_id=' . $module_id : ''), true);
    }
