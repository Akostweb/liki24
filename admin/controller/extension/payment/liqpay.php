...
class ControllerExtensionPaymentLiqPay extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['liqpay_test_payment'])) {
            $data['liqpay_test_payment'] = $this->request->post['liqpay_test_payment'];
        } else {
            $data['liqpay_test_payment'] = $this->config->get('liqpay_test_payment');
        }
